      ...
      <section className="max-w-4xl p-6 mx-auto  rounded-md shadow-md bg-gray-300">
        <form onSubmit={handleSaveToDb}>
          ...
          <div className="flex justify-end mt-6">
            <button className="px-8 py-2.5 leading-5 bg-emerald-700 text-white transition-colors duration-300 transform   rounded-md hover:bg-[#b5d578] focus:outline-none focus:bg-green-600 hover:bg-green-400">
              Add Product
            </button>
          </div>
        </form>
